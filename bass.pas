...
function BASS_Init(device: Integer; freq, flags: DWORD; win: HWND;
  clsid: Pointer): BOOL; stdcall; external bassdll;
{$ELSE}
...
external bassdll;
function BASS_IsStarted: DWORD; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
...
external bassdll;
function BASS_PluginEnable(handle: HPLUGIN; enable: BOOL): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
...
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
function BASS_SampleGetChannel(handle: HSAMPLE; flags: DWORD): DWORD;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
...
external bassdll;
function BASS_ChannelFree(handle: DWORD): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
function BASS_ChannelPlay(handle: DWORD; restart: BOOL): BOOL;
{$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
function BASS_ChannelStart(handle: DWORD): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF};
external bassdll;
